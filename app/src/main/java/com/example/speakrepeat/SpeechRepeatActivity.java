...
//        url = dictionaryEntries();
    ...
    public void requestDictionary(View v,String wordchose){
        url = dictionaryEntries(wordchose);
    ...
    private String dictionaryEntries(String wordchose) {
        final String language = "en";
        final String word = wordchose;
